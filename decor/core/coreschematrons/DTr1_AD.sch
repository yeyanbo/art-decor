...
<rule abstract="true" id="AD" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error" test="not(@nullFlavor) or (not(hl7:thumbnail) or hl7:useablePeriod/@nullFlavor)"
        >dtr1-2-AD: no useablePeriod if null</assert>
    <assert role="error" test="count(*[self::hl7:useablePeriod][@updateMode])=0"
    ...
    <report role="warning" test="*[not(@nullFlavor or self::hl7:useablePeriod)][normalize-space(.)='']"
