...
<rule abstract="true" id="URL.NL.EXTENDED" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error"
        ...
        ) else (1=1)" see="http://tools.ietf.org/html/rfc3966"
    ...
    <assert role="error"
        ...
        ) else (1=1)" see="http://tools.ietf.org/html/rfc1738"
    ...
    <assert role="error"
        ...
        ) else (1=1)" see="http://tools.ietf.org/html/rfc2224"
    ...
    <assert role="error"
        ...
        ) else (1=1)" see="http://tools.ietf.org/html/rfc2368"
