...
<rule abstract="true" id="AD.NL" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error"
           test="if (@codeSystem='2.16.840.1.113883.2.4.4.15') then (
           matches(@code,'^[0-9]{4}[A-Z]{2}$')
           ) else ( 1=1 )">dtr1-1-AD.NL: postcodes onder codeSystem
    ...
    <assert role="error"
           ...
           ) else ( 1=1 )">dtr1-2-AD.NL: Nederlandse postcodes in de text-nodes moeten voldoen aan '9999 AA'</assert>
