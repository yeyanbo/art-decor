...
<rule abstract="true" id="II.NL.BSN" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <assert role="error" test="@nullFlavor or @root='2.16.840.1.113883.2.4.6.3'"
        >dtr1-1-II.NL.BSN: Burgerservicenummer @root MOET 2.16.840.1.113883.2.4.6.3 zijn indien niet null</assert>
    <assert role="error" test="not(@root='2.16.840.1.113883.2.4.6.3') or matches(@extension,'^[0-9]{9}$')"
        >dtr1-2-II.NL.BSN: Burgerservicenummer MOET 9 cijfers lang zijn</assert>
    <assert role="error"
        ...
        >dtr1-3-II.NL.BSN: Burgerservicenummer voldoet niet aan modulo 11 proef</assert>
</rule>
