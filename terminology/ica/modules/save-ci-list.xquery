...
let $icaMapping := request:get-data()/version



let $storedMapping := collection(concat($get:strTerminologyData,'/ica-data/concepts'))//cics/version[@effectiveDate=$icaMapping/@effectiveDate]
let $userInfo := doc($get:strUserInfo)/users
