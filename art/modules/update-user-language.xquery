...
let $userUpdate      :=  aduser:setUserLanguage(xmldb:get-current-user(),$newUserLanguage)

return
    <defaultLanguage>{aduser:getUserLanguage(xmldb:get-current-user())}</defaultLanguage>